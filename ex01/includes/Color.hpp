...
/*   Updated: 2024/05/06 16:18:25 by yichan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define LOG_WARNING(msg) std::cout << YELLOW << "[WARNING] " << msg << RESET << std::endl
#define LOG_ERROR(msg)   std::cerr << RED << "[ERROR] " << msg << RESET << std::endl
#define LOG_TITLE(msg)   std::cerr << GOLD << "[TITLE] " << msg << RESET << std::endl
